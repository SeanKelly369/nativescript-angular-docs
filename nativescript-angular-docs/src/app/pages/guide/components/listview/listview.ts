...
<div class="viz-grid">
  ...
  <figure class="viz-card">
    ...
    <svg class="viz" viewBox="0 0 760 242" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="ListView container and items">
      ...
      <path d="M360 120 C 390 110, 400 110, 420 120" fill="none" stroke="rgba(31,36,48,0.55)" stroke-width="2" stroke-linecap="round"/>
      <path d="M410 112 L 422 120 L 410 128" fill="none" stroke="rgba(31,36,48,0.55)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <text x="368" y="145" font-size="14" font-weight="700" fill="#1f2430" font-family="ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif">bind visible rows</text>
    </svg>
  </figure>
  ...
  <figure class="viz-card">
    ...
    <svg class="viz" viewBox="0 0 760 270" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Virtualization and recycling">
      ...
      <path d="M650 110 C 630 105, 625 140, 650 145" fill="none" stroke="rgba(123, 78, 163, 0.75)" stroke-width="3" stroke-linecap="round"/>
